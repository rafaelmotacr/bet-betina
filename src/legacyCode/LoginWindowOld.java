...
//  standard height and width
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LoginWindowOld window = new LoginWindowOld();
	...
	public LoginWindowOld(MainWindow mainWindowTMP) {
	...
	private void initialize() {
		...
		backBTN.setIcon(new ImageIcon(LoginWindowOld.class.getResource("/resources/backBTN.png")));
		backBTN.setBounds(20, 203, 30, 30);
		...
		lblNewLabel.setIcon(new ImageIcon(LoginWindowOld.class.getResource("/resources/loginBG.png")));
