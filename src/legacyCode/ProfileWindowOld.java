...
//  Standard height and width
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ProfileWindowOld window = new ProfileWindowOld();
	 ...
	 */
	public ProfileWindowOld() {
		if (this.mainWindow != null) {
			this.currentUser = mainWindow.getCurrentUser();
		} else {
			try {
				this.currentUser = dao.findUserByEmail("rafaelmota@gmail.com");
	...
	public ProfileWindowOld(MainWindow mainWindow) {
	...
	private void initialize() {
		...
		profilePictureLabel_1.setIcon(new ImageIcon(ProfileWindowOld.class.getResource("/resources/user.png")));
		...
		editDataBTN.setIcon(new ImageIcon(ProfileWindowOld.class.getResource("/resources/editBTN.png")));
		...
		editPasswordBTN.setIcon(new ImageIcon(ProfileWindowOld.class.getResource("/resources/editBTN.png")));
		...
		profilePictureLabel.setIcon(new ImageIcon(ProfileWindowOld.class.getResource("/resources/user.png")));
		...
		backBTN.setIcon(new ImageIcon(ProfileWindowOld.class.getResource("/resources/backBTN.png")));
