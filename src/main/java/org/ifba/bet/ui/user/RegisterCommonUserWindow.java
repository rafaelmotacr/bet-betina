...
public class RegisterCommonUserWindow extends RegisterUserWindow {
	 ...
	 * comuns. Pode ser tratada como JInternalFrame e possui todos os métodos da
	 * referida classe. Depende de uma MainWindow para ser instanciada corretamente
	...
	public void onRegisterButtonClick(ActionEvent e) {
		...
		try {
			...
			e1.printStackTrace();
			JOptionPane.showMessageDialog(RegisterCommonUserWindow.this, "Erro ao cadastrar Usuário.");
		}
