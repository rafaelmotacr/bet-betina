			...
			public void actionPerformed(ActionEvent e) {
				...
				if (teamMatches > 0) {
					JOptionPane.showMessageDialog(ConfirmDeleteTeamPanel.this.getParent(),
							"Não é possivel deletar o time " + team.getName() + " pois ele está registrado em "
									+ teamMatches + " partida (s)!");
					dispose();
					return;
				}
...
//        PNG de time ilustrativo pra enfeitar
		...
		lblNewLabel.setIcon(new ImageIcon("src/main/resources/time.png"));
